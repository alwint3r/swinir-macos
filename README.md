...
This is a small MLX wrapper around [jingyunliang/SwinIR](https://github.com/jingyunliang/swinir) for real-world x4 image upscaling on macOS. It runs inference with [MLX](https://ml-explore.github.io/mlx/build/html/index.html) and prefers the Apple GPU when available.
